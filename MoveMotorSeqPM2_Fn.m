...
SequenceLength=15e-3;Direction=1;%0 is forward 1 is backward
MS1_StepFactor=2;
MS2_StepFactor=5;
MT1_StepFactor=1;
MT2_StepFactor=4;
...
disp('MMMT for MS1')
SetupMMMT_MS1=MoveMotorMatchTension('MSA',1,1,InitialTension,0.1,MS_CorrectionStepsize*20,obj1,0);
disp('MMMT for MS2')
SetupMMMT_MS2=MoveMotorMatchTension('MSB',3,3,InitialTension,0.1,MS_CorrectionStepsize*20,obj1,1);
AfterInitTime=toc;
%Set up motors
%MSA forward
...
FinalMMMT_MS1=MoveMotorMatchTension('MSA',1,1,InitialTension,0.1,MS_CorrectionStepsize*10,obj1,0);
disp('MMMT for MSB at end of PM2')
FinalMMMT_MS2=MoveMotorMatchTension('MSB',3,3,InitialTension,0.1,MS_CorrectionStepsize*10,obj1,1);
AfterFinalTime=toc;
toc
