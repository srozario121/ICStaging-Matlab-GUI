...
SetupMMMT_MS2=MoveMotorMatchTension('MSB',2,6,InitialTension,0.1,MS_CorrectionStepsize*0.5,obj1,1);
SetupMMMT_MS1=MoveMotorMatchTension('MSA',1,5,InitialTension,0.1,MS_CorrectionStepsize,obj1,1);
pause(0.3);
...
FinalMMMT_MS1=MoveMotorMatchTension('MSA',1,5,InitialTension,0.1,MS_CorrectionStepsize,obj1,1);
FinalMMMT_MS2=MoveMotorMatchTension('MSB',2,6,InitialTension,0.1,MS_CorrectionStepsize,obj1,1);
pause(1);
%Stop Motors
...
MS2_Correction=FinalMMMT_MS2.StepCount;
MS1_Correction=FinalMMMT_MS1.StepCount;
%fprintf(fileID,'%s,%s,%s,%s,%s,%s,%s,%s \n','Date','SequenceLength',...
%'MS_CorrectionStepsize','SpoolDirection','InitialTension',...
%'MS1 Correction Step size','MS2 Correction Step size');
fprintf(fileID,'%s,%d,%d,%d,%d,%d,%d,%d \n',datestr(now),SequenceLength_PM1/1e-3,...
    MS_CorrectionStepsize,SpoolDirection,InitialTension,int32(MS1_Correction),int32(MS2_Correction),int32(t_elapsed)); 
fclose(fileID);